...
export const SERVICE_CATEGORIES = {
  "health": {
    "name_th": "สาธารณสุข/โรงพยาบาล",
    "name_en": "Health & Medical",
    "color": "#ef4444",
    "icon": "🏥"
  },
  "police": {
    "name_th": "สถานีตำรวจ/ความปลอดภัย",
    "name_en": "Police Station",
    "color": "#3b82f6",
    "icon": "👮"
  },
  "fire": {
    "name_th": "งานดับเพลิง/กู้ภัย",
    "name_en": "Fire & Rescue",
    "color": "#f97316",
    "icon": "🚒"
  },
  "welfare": {
    "name_th": "พัฒนาสังคม/ผู้สูงอายุ",
    "name_en": "Social Welfare",
    "color": "#8b5cf6",
    "icon": "🤝"
  },
  "post": {
    "name_th": "ไปรษณีย์/ขนส่งพัสดุ",
    "name_en": "Postal Services",
    "color": "#06b6d4",
    "icon": "📮"
  },
  "waste": {
    "name_th": "สุขาภิบาล/จัดการขยะ",
    "name_en": "Sanitation",
    "color": "#22c55e",
    "icon": "♻️"
  }
